...
describe('Button', function () {
    it('renders a button by default', function () {
        var component = TestUtils.renderIntoDocument(_React2['default'].createElement(Button, null));
        expect(_React2['default'].findDOMNode(component)).toBeDefined();
    });

    it('renders an anchor the `href` property is set', function () {
        var component = TestUtils.renderIntoDocument(_React2['default'].createElement(Button, { href: '#' }));
        var node = _React2['default'].findDOMNode(component);
        expect(node.tagName).toBe('A');
    });

    it('transfers the `href` property to the anchor', function () {
        var component = TestUtils.renderIntoDocument(_React2['default'].createElement(Button, { href: '#test' }));
        var node = _React2['default'].findDOMNode(component);
        expect(node.href).toMatch(/#test$/);
    });

    it('adds the `pure-button` class', function () {
        var component = TestUtils.renderIntoDocument(_React2['default'].createElement(Button, { className: 'my-button' }));
        var node = _React2['default'].findDOMNode(component);
    ...
    it('adds the `pure-button-active` class if the `active` property if set', function () {
        var component = TestUtils.renderIntoDocument(_React2['default'].createElement(Button, { active: true }));
        var node = _React2['default'].findDOMNode(component);
    ...
    it('adds the `pure-button-disabled` class if the `disabled` property if set', function () {
        var component = TestUtils.renderIntoDocument(_React2['default'].createElement(Button, { disabled: true }));
        var node = _React2['default'].findDOMNode(component);
    ...
    it('adds the `pure-button-primary` class if the `primary` property if set', function () {
        var component = TestUtils.renderIntoDocument(_React2['default'].createElement(Button, { primary: true }));
        var node = _React2['default'].findDOMNode(component);
